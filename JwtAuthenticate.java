//JWTAuthenticate - contains the logic for verifying the authenticity user credentials, will throw an unauthorized response if incorrect
...
public class JwtAuthenticate implements AuthenticationEntryPoint, Serializable {
    // serialVersionUID serves as the "state" of a serializable object. This is used by Java in deserializing a serialized object.
    // serialization is the process of transmitting information in a different data structure.
    // ie. an object is serialized into a string to be transmitted and gets deserialized back into an object when it reaches its destination
