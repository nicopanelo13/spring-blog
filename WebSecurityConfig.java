...
//WebSecurityConfig - class that contains the following:
    // - instantiation of a BycryptPassword Encoder object for use in hashin a user's password upon registration
    //- which routes exempt from auth (auth will be implemented on other routes)
